...
VOID RtcWrite(UINT8 Address, UINT8 Data)
{
	...
	RtcWrite_Original(Address,Data);
  ...
  )
{
  ...
  UINTN           DataSize;
  UINT32          TimerVar;
   BOOLEAN        IsCmosBad;			//haven_20170929
  
  DEBUG((EFI_D_ERROR, "DLA_PcRtc.c:PcRtcInit\n"));	  
 ...
 // RtcWrite (RTC_ADDRESS_REGISTER_D, RegisterD.Data);
  ...
  if (EFI_ERROR (Status)) {
    ...
    DEBUG((EFI_D_ERROR, "DLA_PcRtc.c:PcRtcInit(), EFI_DEVICE_ERROR:AAAAAAAAA\n"));		
  ...
  IsCmosBad = (RtcRead(0x0E) & BIT7)?TRUE:FALSE;	
  if (EFI_ERROR (Status) || IsCmosBad ) {			
  ...
  DEBUG((EFI_D_ERROR, "DLA_PcRtc.c:PcRtcInit(), EFI_DEVICE_ERROR:BBBBBBBBB\n"));	  
    return EFI_DEVICE_ERROR;
  }
}
  ...
  )
{
  ...
  if (EFI_ERROR (Status)) {
    ...
    DEBUG((EFI_D_ERROR, "DLA_PcRtc.c:PcRtcGetTime(), EFI_DEVICE_ERROR:AAAAAAAAA\n"));		
    return EFI_DEVICE_ERROR;
  }
  ...
  )
{
  ...
  //DEBUG((EFI_D_ERROR, "PcRtcSetWakeupTime()\n"));	  
