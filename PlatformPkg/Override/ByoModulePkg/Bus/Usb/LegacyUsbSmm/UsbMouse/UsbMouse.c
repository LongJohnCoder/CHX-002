...
--*/
{
    ...
    if ((UsbMouse->PrivateData.ButtonDetected) && (UsbMouse->PrivateData.ButtonMinIndex == 0)) {
    ...
    {
      if ((UsbMouse->PrivateData.ButtonDetected) && (UsbMouse->PrivateData.ButtonMaxIndex == 0)) {
