...
)
{
	...
	DEBUG((DEBUG_ERROR,"PcieRstPE4 = %x \n",NbCfg->PcieRstPE4));	
	...
	DEBUG((DEBUG_ERROR,"PcieRstPE5 = %x \n",NbCfg->PcieRstPE5)); 
	DEBUG((DEBUG_ERROR,"PcieRP = %x \n",NbCfg->PcieRP));	
	//DEBUG((DEBUG_ERROR,"PciePEG = %x \n",NbCfg->PciePEG));	
	DEBUG((DEBUG_ERROR,"PciePE4 = %x \n",NbCfg->PciePE4));	
	...
	DEBUG((DEBUG_ERROR,"PciePE5 = %x \n",NbCfg->PciePE5));	
	DEBUG((DEBUG_ERROR,"PciePE6 = %x \n",NbCfg->PciePE6));	
	DEBUG((DEBUG_ERROR,"PciePE7 = %x \n",NbCfg->PciePE7));	
