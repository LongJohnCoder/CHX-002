	...
	EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL *PciRBIo)
{
	...
	Data16 = 0;
	//0x44-0x45 EFGH
	Status = PciRBIo->Pci.Write( PciRBIo, EfiPciWidthUint16, CHX002_BUSC | D17F0_PCI_PNP_INTR_ROUTING_INTE_INTF, 1, &Data16);
	//0x54-0x57 ABCD
	Status = PciRBIo->Pci.Read( PciRBIo, EfiPciWidthUint32, CHX002_BUSC | D17F0_PCI_BUS_AND_CPU_IF_CTL, 1, &Data32);
	Data32 &=~(0xF0FFF00F);
	Status = PciRBIo->Pci.Write( PciRBIo, EfiPciWidthUint32, CHX002_BUSC | D17F0_PCI_BUS_AND_CPU_IF_CTL, 1, &Data32);
