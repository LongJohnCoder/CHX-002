...
MEDIA_BLOCK_MAP device_block_map[] = {
    RECORD_ENTRY_32M_OF_64K_BLOCKS,
    RECORD_MAP_END
};

DEVICE_TABLE mDeviceTable = {
    SF_VENDOR_ID_Numonyx,    // VendorId
    SF_DEVICE_ID0_M25P32,   // DeviceId 0
    SF_DEVICE_ID1_M25P32,   // DeviceId 1
    Numonyx_M25P32_SIZE     // size of the flash part
};
...
)
{
    ...
    mNvDevice->FlashSize = Numonyx_M25P32_SIZE;
