...
static dumpRegister SBRegList[] = {
	...
	*/
	...
	{L"D16F7_USB20_P3_PHY", 				DUMP_USB2_D16F7_L2,		CHX002_DUMP_D16F7_PHY_P3_CTRL,				0x3000,		0x300F},	
	{L"D16F7_USB20_P4_PHY", 				DUMP_USB2_D16F7_L2,		CHX002_DUMP_D16F7_PHY_P4_CTRL,				0x4000,		0x400F},	
	{L"D16F7_USB20_PHY_TEST_CTRL", 			DUMP_USB2_D16F7_L2,		CHX002_DUMP_D16F7_PHY_TEST_CTRL,				0x10000,	0x1000F},	
...
VOID DumpSBValue (
  ...
  )
 {
    ...
    DEBUG((EFI_D_ERROR,"DLA:dumpSBDefaultValue():CountToDump(%d)\n",CountToDump));
