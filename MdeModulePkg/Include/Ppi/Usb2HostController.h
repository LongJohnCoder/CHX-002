...
typedef
EFI_STATUS
(EFIAPI *PEI_USB_HOST_CONTROLLER_GET_HOST_CONTROLLER_TYPE) (
  IN  EFI_PEI_SERVICES              **PeiServices,
  IN  PEI_USB2_HOST_CONTROLLER_PPI  *This,
...
typedef
EFI_STATUS
(EFIAPI *PEI_XHCI_APPLY_DEVICE_SLOT) (
  IN  EFI_PEI_SERVICES              **PeiServices,
  IN  PEI_USB2_HOST_CONTROLLER_PPI  *This,
...
typedef
EFI_STATUS
(EFIAPI *PEI_XHCI_SET_CONFIGRATION)(
  IN EFI_PEI_SERVICES               **PeiServices,
  IN PEI_USB2_HOST_CONTROLLER_PPI   *This,
  IN UINT8                          DeviceAddress,
...
typedef
EFI_STATUS
(EFIAPI *PEI_XHCI_EVALUATE_CONTEXT)(
  IN EFI_PEI_SERVICES               **PeiServices,
  IN PEI_USB2_HOST_CONTROLLER_PPI   *This,
  IN UINT8                          DeviceAddress,
  IN BOOLEAN                        Slot,
...
typedef
EFI_STATUS
(EFIAPI *PEI_XHCI_UPDATE_SLOT_CONTEXT)(
  IN EFI_PEI_SERVICES               **PeiServices,
  IN PEI_USB2_HOST_CONTROLLER_PPI   *This,
  IN UINT8                          DeviceAddress,
  IN UINT8                          Hub,
...
typedef struct _PEI_USB3_HOST_CONTROLLER_FUNC
{
  PEI_XHCI_APPLY_DEVICE_SLOT        ApplyDeviceSlot;
  PEI_XHCI_SET_CONFIGRATION         SetConfiguration;
  PEI_XHCI_EVALUATE_CONTEXT         EvaluateContext;
  PEI_XHCI_UPDATE_SLOT_CONTEXT      UpdateSlotContext;
} PEI_USB3_HOST_CONTROLLER_FUNC;
...
struct _PEI_USB2_HOST_CONTROLLER_PPI {
  ...
  PEI_USB_HOST_CONTROLLER_GET_HOST_CONTROLLER_TYPE    GetHostControllerType;
  PEI_USB3_HOST_CONTROLLER_FUNC                       Usb3HostControllerFunc;
};
