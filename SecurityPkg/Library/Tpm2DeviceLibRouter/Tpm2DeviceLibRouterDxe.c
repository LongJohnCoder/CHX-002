...
{
  if (PcdGet8(PcdTpmInstanceId) != Tpm2Device->ProviderId){
    DEBUG ((EFI_D_ERROR, "WARNING: Tpm2RegisterTpm2DeviceLib - does not support ID %d registration\n", Tpm2Device->ProviderId));
    return EFI_UNSUPPORTED;
  }
