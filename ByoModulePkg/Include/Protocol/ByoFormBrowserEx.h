...
#define BROWSER_ACTION_SAVE_USER_DEFAULT         BIT5
#define BROWSER_ACTION_LOAD_USER_DEFAULT         BIT6
#define BROWSER_ACTION_CONFIG_OS_OPTIMIZED_DEFAULTS  BIT7
#define BROWSER_ACTION_ENABLE_OS_OPTIMIZED_DEFAULTS  BIT8
#define BROWSER_ACTION_DISABLE_OS_OPTIMIZED_DEFAULTS BIT9
#define BROWSER_ACTION_SECURE_BOOT_CONFIG            BIT10
#define BROWSER_ACTION_RESET_TO_SETUP_MODE           BIT11
#define BROWSER_ACTION_RESTORE_FACTORY_KEYS          BIT12
#define BROWSER_ACTION_GET_OS_OPTIMIZED                   BIT13
#define BROWSER_ACTION_GET_VIEW_MODE                        BIT14

#define BROWSER_ACTION_GET_SECURE_BOOT_STATUS      BIT15
#define BROWSER_ACTION_SET_SECURE_BOOT_STATUS      BIT16

#define BROWSER_ACTION_PREVIOUS_VALUE              BIT17
